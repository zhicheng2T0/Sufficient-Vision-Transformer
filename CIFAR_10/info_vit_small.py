    ...
    for k in range(len(num_dim)):
        ...
        for epoch in range(epochs):
            ...
            for step, (batch_x,batch_y) in enumerate(train_loader):
                ...
                if k==0:
                    m0p=MINE_list[0](x0.detach(),x1.detach())
                    m0q=MINE_list[0](x10.detach(),x1.detach())

                    m1p=MINE_list[1](x0.detach(),x2.detach())
                    m1q=MINE_list[1](x10.detach(),x2.detach())

                    m2p=MINE_list[2](x0.detach(),x3.detach())
                    m2q=MINE_list[2](x10.detach(),x3.detach())
                ...
                if k==1:
                    m3p=MINE_list[0](x0.detach(),x4.detach())
                    m3q=MINE_list[0](x10.detach(),x4.detach())

                    m4p=MINE_list[1](x0.detach(),x5.detach())
                    m4q=MINE_list[1](x10.detach(),x5.detach())

                    m5p=MINE_list[2](x0.detach(),x6.detach())
                    m5q=MINE_list[2](x10.detach(),x6.detach())

                    m6p=MINE_list[3](x0.detach(),x7.detach())
                    m6q=MINE_list[3](x10.detach(),x7.detach())
