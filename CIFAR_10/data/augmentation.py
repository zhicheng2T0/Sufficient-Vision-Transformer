...
def get_nhrt2tvit_aug(res=224, erase=True):
    mean = (0.485, 0.456, 0.406)
    aa_params = dict(
            translate_const=int(res * 0.45),
            img_mean=tuple([min(255, round(255 * x)) for x in mean]),
...
def get_deit_aug_nordaug(res=224, erase=True):
    mean = (0.485, 0.456, 0.406)
    aa_params = dict(
            translate_const=int(res * 0.45),
            img_mean=tuple([min(255, round(255 * x)) for x in mean]),
...
def get_deit_aug_nordaug_nocolorjitter(res=224, erase=True):
    mean = (0.485, 0.456, 0.406)
    aa_params = dict(
            translate_const=int(res * 0.45),
            img_mean=tuple([min(255, round(255 * x)) for x in mean]),
...
def get_deit_aug_noall(res=224, erase=True):
    mean = (0.485, 0.456, 0.406)
    aa_params = dict(
            translate_const=int(res * 0.45),
            img_mean=tuple([min(255, round(255 * x)) for x in mean]),
