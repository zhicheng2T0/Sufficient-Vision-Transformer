...
def main():
    ...
    change_layer_list=[6,1,None]

    inter_layer_num_=[(num0,num1,16),(num1,num2,5)]
    ...
    for epoch in range(epochs):
        ...
        for step, (batch_x,batch_y) in enumerate(train_loader):
            ...
            prediction,x_start_list,x_0list,x_1list=model(batch_x0)
            x_0=x_start_list[0]
            x_00=x_0list[0]
            x_01=x_1list[0]
            x_1=x_start_list[1]
            ...
            if step==int(num_train/batch_size)-100:
                ...
                model.eval()
                train_loss_sum=0
                loss=loss_func(prediction,batch_y0)
                losst=loss.cpu()
