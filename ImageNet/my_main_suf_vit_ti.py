...
from network.suf_vit_ti import *
...
parser.add_argument('--ckpt_path', type=str, default='suf_deit_tiny_case2_arch1', help='path to training dataset')
parser.add_argument('--case', type=int, default=1, help='case of architecture')
